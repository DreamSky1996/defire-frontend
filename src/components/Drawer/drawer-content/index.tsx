...
// import StripIcon from "../../../assets/icons/strip.png";
import DefireIcon from "../../../assets/icons/DeFIRE.png";
    ...
    return (
        <div className="dapp-sidebar">
            <div className="branding-header">
                <Link href="/">
                    <img alt="" src={DefireIcon}  style={style}/>
                </Link>

                {address && (
                    <div className="wallet-link">
                        <Link href={`https://cchain.explorer.avax-test.network/address/${address}`} target="_blank">
                            <p>{shorten(address)}</p>
                        </Link>
                    </div>
                )}
